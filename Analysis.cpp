...
bool Analysis::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("dPT_Scalar_leptons_e", 100, -50.0, 50.0);
  plot_dPT_Scalar_leptons_e = new TH1F("dPT_Scalar_leptons_e", "dPT_Scalar_leptons_e", 100, -50.0, 50.0);
  
  Manager()->AddHisto("dPT_Vector_leptons_e", 100, -50.0, 50.0);
  plot_dPT_Vector_leptons_e = new TH1F("dPT_Vector_leptons_e", "dPT_Vector_leptons_e", 100, -50.0, 50.0);
  ...
  Manager()->AddHisto("dPT_Scalar_leptons_mu", 100, -50.0, 50.0);
  plot_dPT_Scalar_leptons_mu = new TH1F("dPT_Scalar_leptons_mu", "dPT_Scalar_leptons_mu", 100, -50.0, 50.0);
  
  Manager()->AddHisto("dPT_Vector_leptons_mu", 100, -50.0, 50.0);
  plot_dPT_Vector_leptons_mu = new TH1F("dPT_Vector_leptons_mu", "dPT_Vector_leptons_mu", 100, -50.0, 50.0);
